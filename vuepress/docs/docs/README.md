...
```scala
"com.github.ghostdogpr" %% "caliban" % "2.11.2"
```
...
```scala
"com.github.ghostdogpr" %% "caliban-http4s"     % "2.11.2" // routes for http4s
"com.github.ghostdogpr" %% "caliban-akka-http"  % "2.11.2" // routes for akka-http
"com.github.ghostdogpr" %% "caliban-pekko-http" % "2.11.2" // routes for pekko-http
"com.github.ghostdogpr" %% "caliban-play"       % "2.11.2" // routes for play

"com.github.ghostdogpr" %% "caliban-cats"       % "2.11.2" // interop with cats-effect
"com.github.ghostdogpr" %% "caliban-monix"      % "2.11.2" // interop with monix
"com.github.ghostdogpr" %% "caliban-tapir"      % "2.11.2" // interop with tapir

"com.github.ghostdogpr" %% "caliban-federation" % "2.11.2" // apollo federation
"com.github.ghostdogpr" %% "caliban-reporting"  % "2.11.2" // apollo schema reporting
"com.github.ghostdogpr" %% "caliban-tracing"    % "2.11.2" // open-telemetry
```

...
```scala
"com.github.ghostdogpr" %% "caliban-http4s"     % "3.0.0" // routes for http4s
"com.github.ghostdogpr" %% "caliban-akka-http"  % "3.0.0" // routes for akka-http
"com.github.ghostdogpr" %% "caliban-pekko-http" % "3.0.0" // routes for pekko-http
"com.github.ghostdogpr" %% "caliban-play"       % "3.0.0" // routes for play

"com.github.ghostdogpr" %% "caliban-cats"       % "3.0.0" // interop with cats-effect
"com.github.ghostdogpr" %% "caliban-monix"      % "3.0.0" // interop with monix
"com.github.ghostdogpr" %% "caliban-tapir"      % "3.0.0" // interop with tapir
